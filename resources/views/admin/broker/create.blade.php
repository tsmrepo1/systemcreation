                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Add Broker Details</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="POST" action="{{ route('brokers.store') }}" id="add-member-form">
                                @csrf
                                <div class="col-md-3">
                                    <label for="inputMenberName" class="form-label">Broker's Name</label>
                                    <input type="text" class="form-control" value="{{ old('broker_name') }}" name="broker_name">
                                </div>
                                <div class="col-md-3">
