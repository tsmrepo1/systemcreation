    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Add Cashier</div>
                <div class="ps-3">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Add Cashier Details</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="POST" action="{{ route('cashiers.store') }}" id="add-member-form">
                                @csrf
                                <div class="col-md-3">
                                    <label for="inputMenberName" class="form-label">Cashier Name</label>
                                    <input type="text" class="form-control" value="{{ old('cashier_name') }}" name="cashier_name">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('cash_in_hand') }}" name="cash_in_hand">
                                </div>
