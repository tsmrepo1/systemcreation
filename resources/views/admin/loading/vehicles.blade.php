    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Search By Vehicles</div>
            </div>
            <!--end breadcrumb-->
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-primary">Vehicles</h5>
                            </div>
                            <hr>
                            
                            <form action="{{ route('loadings.search.vehicle') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="single-select" name="vehicle_id">
                                                <option value="">--select--</option>
                                                @foreach($vehicles as $vehicle)
                                                    <option value="{{ $vehicle->id }}" 
                                                        <?php if(isset($vehicle_id) && $vehicle_id == $vehicle->id) echo "selected" ?>>{{ $vehicle->vehicle_no }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
